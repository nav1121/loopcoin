...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/Loopcoin"));
    setWindowIcon(QIcon(":icons/Loopcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/Loopcoin"), tr("&About Peercoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/Loopcoin"), tr("&Show / Hide"), this);
    ...
    openChatroomAction = new QAction(QIcon(":/icons/Loopcoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://Loopcoin.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/Loopcoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.Loopcoin.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/Loopcoin_testnet"));
            setWindowIcon(QIcon(":icons/Loopcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Loopcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://Loopcoin.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.Loopcoin.net"));
}
