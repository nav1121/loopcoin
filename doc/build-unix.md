...
UNIX BUILD NOTES FOR LOOPCOIN
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/Loopcoin/Loopcoin
	cd Loopcoin
...
Note: Currently, there is no Loopcoin ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip Loopcoind" to strip the debug
