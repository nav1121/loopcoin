...
Setup
-----
After completing windows setup then run Loopcoin-qt.
Alternatively you can run windows command line (cmd) in Loopcoin program dir.
  cd daemon
  Loopcoind
You would need to create a configuration file Loopcoin.conf in the default
wallet directory. Grant access to Loopcoind/Loopcoin-qt in anti-virus and firewall
